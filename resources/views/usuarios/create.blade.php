                    ...
                    <form method="POST" action="{{ route('usuarios.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <select name="rol" id="rol" required
                                ...
                                <option value="conductor" {{ old('rol')=='conductor' ? 'selected' : '' }}>Conductor
                                </option>
                                <option value="supervisor" {{ old('rol')=='supervisor' ? 'selected' : '' }}>Supervisor
                                </option>
                        ...
                        <div>
                            ...
                            <select name="idioma" id="idioma" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-900 dark:border-gray-700 dark:text-white sm:text-sm">
                                <option value="es" {{ old('idioma', 'es' )=='es' ? 'selected' : '' }}>Español</option>
                                <option value="en" {{ old('idioma')=='en' ? 'selected' : '' }}>Inglés</option>
                                <option value="de" {{ old('idioma')=='de' ? 'selected' : '' }}>Alemán</option>
                            </select>
