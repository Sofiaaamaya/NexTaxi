...
const sizeConfig = {
  ...
  "18|22": "text-[18px] md:text-[22px] leading-[130%] md:leading-[120%]",  // ← nueva
  "20|24": "text-[20px] md:text-[24px] leading-[130%] md:leading-[120%]",
  "24|32": "text-[24px] md:text-[32px] leading-[120%] md:leading-[110%]",
  "30|42": "text-[30px] md:text-[42px] leading-[110%] md:leading-[110%]",  // ← nueva
...
const colorMap = {
  ...
  warning:     "text-warning-normal",
  info:        "text-info-normal",
  neutral:     "text-neutrals-normal",
  neutralDark: "text-neutrals-dark",
  white:       "text-white",
