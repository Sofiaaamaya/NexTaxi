          ...
          <div className="flex items-center gap-3 mb-8">
            {[1, 2, 3].map((s) => (
              <div key={s} className="flex items-center gap-2">
                <div
                  className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium ${step >= s ? 'bg-primary text-white' : 'bg-background text-textSecondary'}`}
                >
                  {s}
                </div>
              ...
              <>
                ...
                <div className="flex flex-col gap-4">
                  {[
                    ...
                    <div key={field.id}>
                      <Poppins
                        text={t(`form.fields.${field.id}.label`)}
                        tag="label"
                        size="14|18"
                        weight="medium"
                      />
            ...
            {step === 2 && (
              <>
                ...
                <div className="flex flex-col gap-4">
                  <div>
                    <Poppins
                      text={t('form.fields.numeroLicencia.label')}
                      tag="label"
                      size="14|18"
                      weight="medium"
                    />
                  ...
                  <div>
                    <Poppins
                      text={t('form.fields.licenciaExpira.label')}
                      tag="label"
                      size="14|18"
                      weight="medium"
                    />
            ...
            {step === 3 && (
              <>
                ...
                <div className="flex flex-col gap-4">
                  <div>
                    <Poppins
                      text={t('form.fields.matricula.label')}
                      tag="label"
                      size="14|18"
                      weight="medium"
                    />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <Poppins
                        text={t('form.fields.marca.label')}
                        tag="label"
                        size="14|18"
                        weight="medium"
                      />
                    ...
                    <div>
                      <Poppins
                        text={t('form.fields.modelo.label')}
                        tag="label"
                        size="14|18"
                        weight="medium"
                      />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      <Poppins
                        text={t('form.fields.plazas.label')}
                        tag="label"
                        size="14|18"
                        weight="medium"
                      />
